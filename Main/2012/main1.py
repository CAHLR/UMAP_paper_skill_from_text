...
import pandas as pd
d = {}
d["window_size"] = [60]##+list(range(20, 160, 20))
d["vector_size"] = list(range(192, 193, 32))
d["dataset"] = "2012"
d["min_count"] = [10]
d["classifier_type"] = "supervised"
d["optimization_type"] = "validation"
d["split_type"] = "problem"
d["distance_measure"] = "NA"
...
df.to_csv("Result/2012/3TempKC1.csv", sep=",", index=False)
print (df)
